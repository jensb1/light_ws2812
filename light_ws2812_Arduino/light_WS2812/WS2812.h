...
private:
	...
	void light_WS2812_sendarray_mask(uint8_t *array,uint16_t length, uint8_t pinmask,uint8_t *port, uint8_t *portreg);

	const volatile uint8_t *light_WS2812_port;
	volatile uint8_t *light_WS2812_port_reg;
	uint8_t pinMask; 
};
